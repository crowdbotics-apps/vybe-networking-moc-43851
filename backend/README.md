...
## Project Structure
    ...
    ├── vybe_networking_moc_43851  # Django project configurations
...
1. Clone this repo and `cd vybe_networking_moc_43851`
...
2. Clone this repo and `cd vybe_networking_moc_43851`
